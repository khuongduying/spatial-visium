...
print(p1)
ggsave(paste0(fig_path,"CARD_proportion_10X.png"), p1, width=3000, height=3000, unit="px", dpi=300)
...
print(p4)
ggsave(paste0(fig_path,"CARD_correlation_10X.png"), p4, width=3000, height=3000, unit="px", dpi=300)
...
library(ggplot2)
df = MapCellCords
colors = c("#ed3e24","orange","pink","green","blue","yellow",
	"orange","#CDD796","#F8CDDE","#8DD3C7","#CFECBB","#F4F4B9","#CFCCCF","#D1A7B9","#E9D3DE","#F4867C","#C0979F",
	"#D5CFD6")
...
print(p10)
ggsave(paste0(fig_path,"CARD_celltype_sc_res_10X.png"), p10, width=3000, height=3000, unit="px", dpi=300)
